...
### tutto ok a parte parte 1 e 2 fatte insieme e senza uscire dalla console
...
### es json quasi finito, manca solo la restrizione per chi si registra di dover scegliere un nome utente che non sia gia tra i json
...
### esercizio json completo di registrazione solo se l'utente non è gia presente nel file json
...
### esercizio json con anche i commenti e risolto problema riguardante la creazione del primo json se non esiste già
```c#
...
### es json con commenti e bug relativi al calcolo del balance risolti
...
### es json con correzioni dopo il beta test di giada
...
### es json con 2 bug risolti + aggiunta trim e toLower allo y/n 
...
### es json - messo json per tracciare prodotti disponibili e prezzo al posto di usare il dictionary
        ...
        while (true)
        {
            ...
            if (scelta == "1")
            {
                ...
                if (File.Exists(pathJsonUtentiEPassword))
                {
                    ...
                    foreach (var jsonElement in obj)
                    {
                        System.Console.WriteLine(jsonElement);
                        cont++;
                        if (jsonElement.nomeutente == nomeUtente)
                        {
                            System.Console.WriteLine("Quest'utente esiste già");
                            utenteEsistente = true;
                            nomiUtenti=new List<string>(); //azzero le liste
                            passwords=new List<string>();
                            break;
                        }
                        else
...
## esercizio completo con funzione
...
## aggiunta placeholder random

<img src="https://source.unsplash.com/random/300x200?sig=1&cat" alt="Immagine 1">




## aggiunta google font e icone font awesome

usiamo un serivizio messo in un content delivery network (cdn) come google fonts o font awesome

metti nell'header un font da google fonts:
<link href="https://fonts.googleapis.com/css2?family=Roboto:wght@400;700&display=swap" rel="stylesheet">

poi metti nel css come font family quello che hai scelto


font awesome:

<link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.1/css/all.min.css">
<i class="fa-solid fa-user"></i>     //va messo prima fas di fa-solid.. questo per tutte le icone prima del fa mettere il fas
