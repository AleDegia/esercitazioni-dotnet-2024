...
CREATE TABLE acquisti (id INTEGER PRIMARY KEY AUTOINCREMENT, numero INTEGER, cliente TEXT, prodotto TEXT, id_cliente INTEGER, id_prodotto INTEGER, FOREIGN KEY (id_cliente) REFERENCES clienti(id), FOREIGN KEY (id_prodotto) REFERENCES prodotti(id));
...
SELECT * FROM acquisti WHERE acquisti.cliente = 'Luca'; 
